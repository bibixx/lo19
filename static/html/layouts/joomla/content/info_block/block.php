...
$db = JFactory::getDbo();
$db->setQuery("SELECT cat.id FROM #__categories cat WHERE cat.title='Bez kategorii'");
$no_cat_id = $db->loadResult();
...
?>
	<small>
		...
		<?php if ($displayData['position'] == 'above' && ($blockPosition == 0 || $blockPosition == 2)
			...
			<?php if ($displayData['params']->get('show_category') && $displayData['item']->catid != $no_cat_id) : ?>
